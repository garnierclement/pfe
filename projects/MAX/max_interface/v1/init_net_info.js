...
function write(val){
  ...
  remove_node_interface(num_nodes);
...
function add_node_interface(nodes, k){
	...
	title_label[k] = this.patcher.newdefault(x_pos+113,y_pos+9,"comment");
	...
	host_label[k] = this.patcher.newdefault(x_pos+17,y_pos+42,"comment");
	...
	name_label[k] = this.patcher.newdefault(x_pos+17,y_pos+67,"comment");
	...
	ip_label[k] = this.patcher.newdefault(x_pos+17,y_pos+92,"comment");
	...
	subscribe_toggle[k] = this.patcher.newdefault(x_pos+202,y_pos+105,"toggle");
	...
	outer_box[k] = this.patcher.newdefault(x_pos,y_pos,"panel");
	...
	title_box[k] = this.patcher.newdefault(x_pos+8,y_pos+6,"panel");
	...
	info_box[k] = this.patcher.newdefault(x_pos+8,y_pos+36,"panel");
